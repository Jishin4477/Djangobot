...
function sendTextMessage() {
    if ($('#messageSendButton1').val() == "") {
        return
    }


    message = {}
    message.text = $('#messageSendButton1').html();
    if (console.log) console.log(message);
    message.command= 'send'
    message.timestamp = new Date();
    
    
    $('#messageSendButton1').val('');
...
function sendTextMessage1() {
    if ($('#messageSendButton2').val() == "") {
        return
    }


    message = {}
    message.text = $('#messageSendButton2').html();
    if (console.log) console.log(message);
    message.command= 'send'
    message.timestamp = new Date();
    
    
    $('#messageSendButton2').val('');
    chatsock.send(JSON.stringify(message));
    console.log(JSON.stringify(message))
    $("#message").val('').focus();
    return false;   
...
function sendTextMessage2() {
    if ($('#messageSendButton3').val() == "") {
        return
    }


    message = {}
    message.text = $('#messageSendButton3').html();
    if (console.log) console.log(message);
    message.command= 'send'
    message.timestamp = new Date();
    
    
    $('#messageSendButton3').val('');
    chatsock.send(JSON.stringify(message));
    console.log(JSON.stringify(message))
    $("#message").val('').focus();
    return false;   
